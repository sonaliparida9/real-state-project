...
const Navbar = () => {
  ...
  // prevent the website scrolling whenever the mobile menu is on
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
        <div className='cotainer mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent '>
