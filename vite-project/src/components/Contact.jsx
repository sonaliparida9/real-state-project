...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "bf887db7-aab5-49ad-b8ae-0563c8ebf89f");
  ...
  return (
    ...
    initial = {{opacity: 0, x:-200}}
     ...
     className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
        <h1 className='text-2xl sm:text-4xl font-bold md-2 text-center'>Contact
            <span className='underline underline-offset-4 decoration-1 under font-light'>With Us</span>
        </h1>
        <p className='text-gary-500 max-w-80 text-center mb-12 mx-auto'>Ready to Make a Move ? Let's Build Your Future Together</p>
