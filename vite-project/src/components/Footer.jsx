    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
            <div className='w-full md:w-1/3 mb-8  md:md-0'>
                ...
                <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi doloremque quas at aliquid provident obcaecati consectetur nam, laborum harum nobis, veritatis exercitationem quis repellendus perspiciatis recusandae tenetur eius, necessitatibus nostrum?</p>
            </div>
            <div className='w-full md:w-1/5 md-8 md:mb-0'>
                <h3 className='text-white text-lg font-bold md-4'>Company</h3>
                <ul className='flex flex-col gap-2 text-gray-400 mt-4'>
                    <a href="#Header"
