...
const Testimonails = () => {
  return (
    ...
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonails'>
        <h1 className='text-2xl sm:text-4xl font-bold md-2 text-center'>Customer 
            <span className='underline underline-offset-4 decoration-1 under font-light'>Testimonials</span>
        </h1>
        <p className='text-gary-500 max-w-80 text-center mb-12 mx-auto'>Real Stories from Those Who Found Home with Us</p>
