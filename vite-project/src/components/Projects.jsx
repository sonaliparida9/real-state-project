...
import assets, { projectsData } from '../../public/assets'
  ...
  return (
    ...
    viewport={{once:true}} 
     className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Project'>
        ...
        <p className='text-center text-gray-500 md-8 max-w-80 mx-auto'>Crafting Spaces, Building Legacies-Explore Our Portfolio</p>
